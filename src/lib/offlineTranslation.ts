...
function buildOfflineResponse(
  ...
  return {
    ...
    critical_details: includeVerification ? response.critical_details ?? [] : [],
    verification_items: includeVerification ? response.verification_items ?? [] : [],
    possible_mismatches: includeVerification ? response.possible_mismatches ?? [] : [],
    requires_human_review: includeVerification ? response.requires_human_review ?? false : false,
...
export function storeTranslationMemory(
  ...
  const nextEntry: TranslationMemoryRecord = {
    ...
    response: {
      ...
      critical_details: response.critical_details ?? [],
      verification_items: response.verification_items ?? [],
      possible_mismatches: response.possible_mismatches ?? [],
